<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImpresionPago.aspx.cs" Inherits="Gestion_Web.Formularios.Pagos.ImpresionPago" %>
                            ...
                            <tr>
                                ...
                                <td style="width: 5%">
                                    <div class="shortcuts" style="height: 100%">
                                        ...
                                        <a href="PagosABM.aspx" class="btn btn-primary ui-tooltip" data-toggle="tooltip" title data-original-title="Agregar" style="width: 100%">
                    ...
                    <div class="widget-content">
                        <div class="panel-body">
                            ...
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="80%">
                                <LocalReport ReportEmbeddedResource="Gestion_Web.Formularios.Pagos.PagosListado.rdlc">
                                </LocalReport>
                                <LocalReport>
                                </LocalReport>
                            </rsweb:ReportViewer>
