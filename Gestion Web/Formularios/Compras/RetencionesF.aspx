<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RetencionesF.aspx.cs" Inherits="Gestion_Web.Formularios.Compras.RetencionesF" %>
        ...
        <div >
            ...
            <div class="col-md-12 col-xs-12">
                <div class="widget stacked">
                    ...
                    <div class="stat">                        
                        <h5><i class="icon-map-marker"></i> Compras > Retenciones</h5>
                    </div>
                                        ...
                                        <td style="width: 20%">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li class="dropdown-submenu dropdown-menu-right"><a tabindex="-1" href="#">Exportar Retenciones</a>  
                                                        <ul class="dropdown-menu" >
                                                            <li>
                                                                <asp:LinkButton ID="lbtnReporteComprasRetencionesXLS" OnClick="lbtnReporteComprasRetencionesXLS_Click" runat="server"  >
                                                                    <i class="fa fa-file-excel-o" aria-hidden="true"></i>
                                                                    &nbsp Imprimir
                                                                </asp:LinkButton>
                                                            </li>
                                                            <li>
                                                                <asp:LinkButton ID="lbtnReporteComprasRetencionesPDF" OnClick="btnRetenciones_Click" runat="server" >
