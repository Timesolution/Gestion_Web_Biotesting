    ...
    public partial class ReportesCobros : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (fechaD == null && fechaH == null && idVendedor == 0 && idSucursal == 0)
                    {
                        this.cargarClientes();
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Response.Redirect("ReportesCobros.aspx?fechadesde=" + txtFechaDesde.Text + "&fechaHasta=" + txtFechaHasta.Text + "&suc=" + DropListSucursal.SelectedValue + "&Cliente=" + DropListClientes.SelectedValue + "&Vendedor=" + DropListVendedores.SelectedValue + "&tipo=" + DropListTipo.SelectedValue + "&estado=" + this.ListEstado.SelectedValue);
                }
                else
                {
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ClientScript.RegisterClientScriptBlock(this.GetType(), "alert", "window.open('/Formularios/Cobros/ImpresionCobro.aspx?Cobro=" + 0 + "&valor=3&fd=" + txtFechaDesde.Text + "&fh=" + txtFechaHasta.Text + "&suc=" + DropListSucursal.SelectedValue + "&cli=" + DropListClientes.SelectedValue + "&ven=" + DropListVendedores.SelectedValue + "&t=" + DropListTipo.SelectedValue + "', 'fullscreen', 'top=0,left=0,width='+(screen.availWidth)+',height ='+(screen.availHeight)+',fullscreen=yes,toolbar=0 ,location=0,directories=0,status=0,menubar=0,resiz able=0,scrolling=0,scrollbars=0');", true);
        ...
        protected void lbtnExportar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("/Formularios/Cobros/ImpresionCobro.aspx?fd=" + txtFechaDesde.Text + "&fh=" + txtFechaHasta.Text + "&cli=" + this.idCliente + "&suc=" + this.idSucursal + "&ven=" + this.idVendedor + "&t=" + this.tipo + "&Cobro=" + 0 + "&valor=5");
            }
            catch
            {
            }
        ...
        protected void lbtnExportar2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Response.Redirect("/Formularios/Cobros/ImpresionCobro.aspx?Cobro=" + 0 + "&valor=3&ex=1");
                Response.Redirect("/Formularios/Cobros/ImpresionCobro.aspx?fd=" + this.fechaD + "&fh=" + this.fechaH + "&cli=" + this.idCliente + "&suc=" + this.idSucursal + "&ven=" + this.idVendedor + "&t=" + this.tipo + "&Cobro=" + 0 + "&valor=3&ex=1");
