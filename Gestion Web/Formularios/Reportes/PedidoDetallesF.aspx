<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PedidoDetallesF.aspx.cs" Inherits="Gestion_Web.Formularios.Reportes.PedidoDetallesF" %>
    ...
    <div>
        ...
        <div class="col-md-12 col-xs-12">
            <div class="widget stacked">
                <div class="stat">
                    <h5><i class="icon-map-marker"></i>Reportes > Ventas > Cotizaciones</h5>
                </div>
                ...
                <div class="widget-content">
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 5%">
                                <%--<div class="shortcuts" style="height: 100%; display:none;">
                    ...
                    <div role="form" class="form-horizontal col-md-12">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                            <ContentTemplate>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3">Desc Articulo</label>
                                    <div class="col-md-6">
