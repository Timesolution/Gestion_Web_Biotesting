    ...
    public partial class CRM : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                cargarEventoRango(fechaD, fechaH, fechaVencimientoD, fechaVencimientoH, cliente, Convert.ToInt32(estado), filtroPorFecha, filtroPorFechaVencimiento);
        ...
        // seguir con esto
        private void cargarEventoRango(string fechaD, string fechaH, string fechaVencimientoD, string fechaVencimientoH, int idCliente, int estado, int filtroPorFecha, int filtroPorFechaVencimiento)
        {
            //try
            //{
            //    ControladorClienteEntity controladorClienteEntity = new ControladorClienteEntity();
            ...
            //    var clientesEventos = controladorClienteEntity.GetEventosClientesFilter(fechaD, fechaH, fechaVencimientoD, fechaVencimientoH, idCliente, estado, filtroPorFecha, filtroPorFechaVencimiento);
        ...
        private void cargarEnPh(Clientes_Eventos clientes_Eventos)
        {
            try
            {
                ...
                celEstado.Text = clientes_Eventos.Situacion;
                ...
                btnDetalles.ID = "btnSelec_" + clientes_Eventos.Id;
                ...
                cbSeleccion.ID = "cbSeleccion_" + clientes_Eventos.Id;
