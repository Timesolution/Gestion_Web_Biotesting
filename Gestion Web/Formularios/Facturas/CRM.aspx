...
<%--                                    <div class="form-group">
                                    ...
                                    <%--<div class="form-group">
                                        <label class="col-md-4">Vencimiento Desde</label>
                                        <div class="col-md-4">

                                            <asp:TextBox ID="txtVencimientoDesde" runat="server" class="form-control"></asp:TextBox>

                                            <!-- /input-group -->
                                        </div>
                                        <div class="col-md-4">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<h3>*</h3>" ControlToValidate="txtVencimientoDesde" ValidationGroup="BusquedaGroup" SetFocusOnError="true" ForeColor="Red" Font-Bold="true"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-4">Vencimiento Hasta</label>
                                        <div class="col-md-4">
                                            <asp:TextBox ID="txtVencimientoHasta" runat="server" class="form-control"></asp:TextBox>
                                        </div>
                                        <div class="col-md-4">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="<h3>*</h3>" ControlToValidate="txtVencimientoHasta" ValidationGroup="BusquedaGroup" SetFocusOnError="true" ForeColor="Red" Font-Bold="true"></asp:RequiredFieldValidator>
                                        </div>--%>
                                        <!-- /input-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <asp:DropDownList ID="DropListEstado" runat="server" class="form-control">
                                                ...
                                                <asp:ListItem Value="2">Atrasada</asp:ListItem>
