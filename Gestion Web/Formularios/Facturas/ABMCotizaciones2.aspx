<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ABMCotizaciones2.aspx.cs" Inherits="Gestion_Web.Formularios.Facturas.ABMCotizaciones2" %>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <asp:CheckBox ID="CheckBox1" TextAlign="Left" CssClass="pull-right" Text="Datos Entrega&nbsp&nbsp" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
