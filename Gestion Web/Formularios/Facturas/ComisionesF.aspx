<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ComisionesF.aspx.cs" Inherits="Gestion_Web.Formularios.Facturas.ComisionesF" %>
    ...
    <div>
        <div class="col-md-12 col-xs-12">
            <div class="widget stacked">
                ...
                <div class="stat">
                    <h5><i class="icon-map-marker"></i>Ventas > Comisiones</h5>
                </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Articulo no comisionable</th>
                                            <th>Iva</th>
                                            <th>Total</th>
                                            <th>Padre</th>
                                            <th>Abuelo</th>
                                    ...
                                    <tbody>
                                        <asp:PlaceHolder ID="phComsiones" runat="server"></asp:PlaceHolder>
                                    </tbody>
                                </table>
