<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FacturasImportacion.aspx.cs" Inherits="Gestion_Web.Formularios.Facturas.FacturasImportacion" %>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div role="form" class="form-horizontal col-md-12">
                        ...
                        <div class="form-group">
                            <label class="col-md-4">Generar Remito:</label>
                            <div class="col-md-8">
                                <asp:CheckBox ID="checkRemito" runat="server" />
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <asp:LinkButton ID="btnImportarXML" runat="server" class="btn btn-success" ValidationGroup="OtrosProveedores" Text="<span class='shortcut-icon icon-ok'></span>" OnClick="btnImportarXML_Click"></asp:LinkButton>
                    </div>
                </div>
