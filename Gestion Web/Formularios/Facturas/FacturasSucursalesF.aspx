<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FacturasSucursalesF.aspx.cs" Inherits="Gestion_Web.Formularios.Facturas.FacturasSucursalesF" %>
    ...
    <%--<div class="container">--%><div>
        ...
        <div class="col-md-12 col-xs-12">
            <div class="widget stacked">
                ...
                <div class="stat">
                    <h5><i class="icon-map-marker"></i> Ventas > Vta a sucursales</h5>
                </div>
                            ...
                            <td style="width: 2%">
                                ...
                                <div class="btn-group" style="width: 100%">
                                    ...
                                    <ul class="dropdown-menu" role="menu">        
                                        <li>
                                            <asp:LinkButton ID="btnImprimir" Text="Impresion detalle" runat="server" OnClick="btnImprimir_Click" />
                                        </li>                               
                                        <li>
                                            <asp:LinkButton ID="btnExportar" Text="Exportar detalle" runat="server" OnClick="btnExportar_Click" />
                                        </li>                               
                                    </ul>
                                </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-1">
                                            <asp:RadioButton ID="radioOrigen" runat="server" AutoPostBack="true" GroupName="groupSuc" OnCheckedChanged="radioOrigen_CheckedChanged" />
                                        </div>
                                        <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-1">
                                            <asp:RadioButton ID="radioDestino" runat="server" AutoPostBack="true" GroupName="groupSuc" OnCheckedChanged="radioDestino_CheckedChanged" />                                            
                                        </div>
                                        <div class="col-md-2">
