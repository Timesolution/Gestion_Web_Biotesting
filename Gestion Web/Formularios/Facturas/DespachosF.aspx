<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DespachosF.aspx.cs" Inherits="Gestion_Web.Formularios.Facturas.DespachosF" %>
        ...
        <div>
            <div class="col-md-12 col-xs-12 hidden-print">
                <div class="widget stacked">
                    ...
                    <div class="stat">
                        <h5><i class="icon-map-marker"></i> Ventas > Guias Despacho</h5>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTablesR-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:30%;">Expreso</th>
                                            <th style="width:10%;text-align:right;">Valor</th>
                                            <th style="width:5%;">C.R.</th>
                                            <th style="width:10%;"></th>
                                        </tr>

                                    </thead>
                                    <tbody>
                                        <asp:PlaceHolder ID="phDespachos" runat="server"></asp:PlaceHolder>
                                    </tbody>
                                </table>
                            </div>
                        </div>
