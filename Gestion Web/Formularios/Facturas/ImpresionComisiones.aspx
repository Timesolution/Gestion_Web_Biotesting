<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImpresionComisiones.aspx.cs" Inherits="Gestion_Web.Formularios.Facturas.ImpresionComisiones" %>
                            ...
                            <div class="widget-content">
                               <div class="panel-body">
                                   ...
                                   <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="80%">
                                       <LocalReport ReportEmbeddedResource="Gestion_Web.Formularios.Facturas.Pedidos.rdlc">
                                       </LocalReport>
                                   </rsweb:ReportViewer>
