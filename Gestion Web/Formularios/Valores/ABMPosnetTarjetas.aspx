<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ABMPosnetTarjetas.aspx.cs" Inherits="Gestion_Web.Formularios.Valores.ABMPosnetTarjetas" %>
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 45%">
                                    ...
                                    <div class="col-md-7">
                                        <asp:TextBox ID="txtPosnet" runat="server" class="form-control" disabled></asp:TextBox>
                                        <!-- /input-group -->
                                    </div>
                                </td>
                                <td style="width: 50%">
                                    ...
                                    <div class="col-md-2">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<h3>*</h3>" ControlToValidate="txtTarjeta" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" ValidationGroup="PosnetGroup"></asp:RequiredFieldValidator>
                                    </div>
                                </td>
                                <td style="width: 5%">
