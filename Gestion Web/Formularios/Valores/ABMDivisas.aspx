<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ABMDivisas.aspx.cs" Inherits="Gestion_Web.Formularios.Valores.ABMDivisas" %>
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 45%">
                                            ...
                                            <div class="col-md-2">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="<h3>*</h3>" ControlToValidate="txtMoneda" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" ValidationGroup="DivisaGroup"></asp:RequiredFieldValidator>
                                            </div>
                                        </td>
                                        <td style="width: 50%">
                                            <label class="col-md-3">Cambio</label>
                                            <div class="col-md-7">
                                                
                                                    <asp:TextBox ID="txtCambio" runat="server" class="form-control" onkeypress="javascript:return validarNro(event)" style="text-align:right"></asp:TextBox>
                                                    <%--<asp:DropDownList ID="DropListEmpresa" runat="server" class="form-control" AutoPostBack="True"></asp:DropDownList>--%>
                                                
                                                <!-- /input-group -->
                                            </div>
                                            <div class="col-md-2">
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ErrorMessage="<h3>*</h3>" ControlToValidate="txtCambio"  ValidationExpression="^(\d|-)?(\d|,)*\.?\d\,?\d*$" SetFocusOnError="true" ValidationGroup="DivisaGroup" ForeColor="Red" Font-Bold="true" />
                                            </div>
                                        </td>
                                                                                <td style="width: 5%">
...
<%--                                                <a onclick="btnAgregar_Click" class="btn btn-default ui-tooltip" data-toggle="tooltip" title data-original-title="Agregar" style="width: 100%">
                                                ...
                                                <asp:LinkButton ID="lbtnAgregar" runat="server" Text="<span class='shortcut-icon icon-ok'></span>" class="btn btn-success" OnClick="btnAgregar_Click" Style="width: 100%" ValidationGroup="DivisaGroup"/>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <asp:PlaceHolder ID="phDivisas" runat="server"></asp:PlaceHolder>
                                            </tbody>
                                        </table>
                    ...
                    <div class="modal-body">
                        <div role="form" class="form-horizontal col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <h5>
                                        <asp:Label runat="server" ID="lblMensaje" Text="Esta seguro que desea eliminar esta divisa?" Style="text-align: center"></asp:Label>
                                    </h5>
                                </div>
