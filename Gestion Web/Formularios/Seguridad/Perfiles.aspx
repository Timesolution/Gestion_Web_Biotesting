<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Perfiles.aspx.cs" Inherits="Gestion_Web.Formularios.Seguridad.Perfiles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="main">
                    ...
                    <div class="widget-content">
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="width: 40%">
                                    <div class="col-md-12">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="El campo es obligatorio" ControlToValidate="txtPerfil" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" ValidationGroup="GrupoGroup"></asp:RequiredFieldValidator>
                                    </div>
                                </td>
                                <td style="width: 10%">
                                    <div class="col-md-1">
                                        <div class="shortcuts">
                                            ...
                                            <asp:LinkButton ID="lbtnAgregar" runat="server" Text="<span class='shortcut-icon icon-ok'></span>" class="btn btn-success" OnClick="btnAgregar_Click" ValidationGroup="GrupoGroup" />
                                ...
                                <ContentTemplate>
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <asp:PlaceHolder ID="phPerfiles" runat="server"></asp:PlaceHolder>
                                            </tbody>
                                        </table>
                    ...
                    <div class="modal-body">
                        <div role="form" class="form-horizontal col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <h5>
                                        <asp:Label runat="server" ID="lblMensaje" Text="Esta seguro que desea eliminar el Permiso?" Style="text-align: center"></asp:Label>
                                    </h5>
                                </div>
        ...
        <a class="btn btn-info" style="display: none" data-toggle="modal" id="abreDenegado" href="#modalDenegado">Agregar Tipo Cliente</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <a href="/Default.aspx" class="btn btn-info" style="width: 100%">Continuar</a>
                            <%--<asp:Button runat="server" ID="Button1" Text="Eliminar" class="btn btn-info" OnClick="btnSi_Click"/>--%>
                            <%--                                        <button type="button" class="btn btn-default" data-dismiss="modal" aria-hidden="true">Cancelar</button>--%>
