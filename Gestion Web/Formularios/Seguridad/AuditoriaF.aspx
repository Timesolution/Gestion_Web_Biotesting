<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AuditoriaF.aspx.cs" Inherits="Gestion_Web.Formularios.Seguridad.AuditoriaF" %>
        ...
        <div class="container">
            ...
            <div class="col-md-12 col-xs-12">
                <div class="widget stacked widget-table action-table">
                    ...
                    <div class="widget-header">
                        <i class="icon-user" style="width: 2%"></i>
                        <h3 style="width: 75%">Auditoria
                                ...
                                <ContentTemplate>
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <asp:PlaceHolder ID="phAuditoria" runat="server"></asp:PlaceHolder>
                                            </tbody>
                                        </table>
                    ...
                    <div class="modal-body">
                        <div role="form" class="form-horizontal col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:DropDownList ID="DropListUsuarios" runat="server" class="form-control"></asp:DropDownList>
                                    <!-- /input-group -->
                                </div>
                                <div class="col-md-2">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="<h3>*</h3>" ControlToValidate="DropListUsuarios" InitialValue="-1" ValidationGroup="BusquedaGroup" SetFocusOnError="true" ForeColor="Red" Font-Bold="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="form-group">
