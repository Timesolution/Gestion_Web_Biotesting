<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListasABM.aspx.cs" Inherits="Gestion_Web.Formularios.Facturas.ListasABM" %>
        ...
        <div class="container">
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="widget stacked">
                            ...
                            <div class="stat">                        
                                <h5><i class="icon-map-marker"></i> Maestro > Lista de Precios > Listas</h5>
                            </div>
                                    ...
                                    <tr>
                                        <td style="width: 60%">
                                            <div class="form-group">
                                                <label class="col-md-2">Lista</label>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="El campo es obligatorio" ControlToValidate="txtNombreLista" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" ValidationGroup="PaisGroup"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <div class="modal-body">
                        <div role="form" class="form-horizontal col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <h5>
                                        <asp:Label runat="server" ID="lblMensaje" Text="Esta seguro que desea eliminar la Lista de Precios?" Style="text-align: center"></asp:Label>
                                    </h5>
                                </div>
