<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ABMSubGruposArticulos.aspx.cs" Inherits="Gestion_Web.Formularios.Articulos.ABMSubGruposArticulos" %>
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 45%">
                                            ...
                                            <div class="col-md-6">
                                                <asp:DropDownList ID="ListGruposArticulos" runat="server" class="form-control"></asp:DropDownList>
                                            </div>
                                            <div class="col-md-4">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Campo Obligatorio" ControlToValidate="ListGruposArticulos" InitialValue="-1" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" ValidationGroup="SubGrupoGroup"></asp:RequiredFieldValidator>
                                                </div>
                                        </td>
                                        <td style="width: 45%">
                                            <label class="col-md-2">SubGrupo</label>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="Campo Obligatorio" ControlToValidate="txtSubGrupo" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" ValidationGroup="SubGrupoGroup"></asp:RequiredFieldValidator>
                                                </div>
                                        </td>
                                        <td style="width: 10%">
                                            <div class="col-md-1">
                    ...
                    <div class="modal-body">
                        <div role="form" class="form-horizontal col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <h5>
                                        <asp:Label runat="server" ID="lblMensaje" Text="Esta seguro que desea eliminar el Sub Grupo?" Style="text-align: center"></asp:Label>
                                    </h5>
                                </div>
