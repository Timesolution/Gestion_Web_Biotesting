    ...
    public partial class ImpresionListaPrecios : System.Web.UI.Page
    {
        ...
        private void cargarTableArticulos(int grupo, int subgrupo, int proveedor, int dias)
        {
            try
            {
                ...
                this.dtArticulos.Columns.Add("codigo");
                this.dtArticulos.Columns.Add("descripcion");
                this.dtArticulos.Columns.Add("grupo");
                this.dtArticulos.Columns.Add("subgrupo");
                this.dtArticulos.Columns.Add("moneda");
                this.dtArticulos.Columns.Add("precioVta",typeof(decimal));
                this.dtArticulos.Columns.Add("Ubicacion");
                this.dtArticulos.Columns.Add("Proveedor");
                this.dtArticulos.Columns.Add("Min");
                this.dtArticulos.Columns.Add("Med");
                this.dtArticulos.Columns.Add("Max");                
                this.dtArticulos.Columns.Add("CantidadDto1"); //Desde
                ...
                foreach (Articulo articulo in listArticulos)
                {
                    ...
                    articulo.listaCategoria = artTemporal.listaCategoria;
                    ...
                    drDatos[6] = artTemporal.ubicacion;
        ...
        private void generarReporte()
        {
            try
            {
                ...
                cargarTableArticulos(this.grupo, this.subgrupo, this.proveedor, this.dias);
