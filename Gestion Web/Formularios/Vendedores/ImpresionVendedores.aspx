<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImpresionVendedores.aspx.cs" Inherits="Gestion_Web.Formularios.Vendedores.ImpresionVendedores" %>
                    ...
                    <div class="widget-content">
                        <div class="panel-body">
                            ...
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="80%">
                                <LocalReport ReportEmbeddedResource="Gestion_Web.Formularios.Clientes.InformeProveedores.rdlc">
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <!-- /.content -->
