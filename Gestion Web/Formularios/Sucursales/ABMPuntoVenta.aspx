<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ABMPuntoVenta.aspx.cs" Inherits="Gestion_Web.Formularios.Sucursales.ABMPuntoVenta" %>
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <td style="width: 5%">
                                            ...
                                            <a href="/" class="btn btn-primary ui-tooltip" data-toggle="tooltip" title data-original-title="Agregar" style="width: 100%" id="btnAgregar" runat="server">
...
<%--                                <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                                    <ContentTemplate>--%>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <asp:PlaceHolder ID="phPuntosVenta" runat="server"></asp:PlaceHolder>
                                            </tbody>
                                        </table>
                    ...
                    <div class="modal-body">
                        <div role="form" class="form-horizontal col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <h5>
                                        <asp:Label runat="server" ID="lblMensaje" Text="Esta seguro que desea eliminar el Punto de Venta?" Style="text-align: center"></asp:Label>
                                    </h5>
                                </div>
