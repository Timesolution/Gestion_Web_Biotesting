<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ABMGruposClientes.aspx.cs" Inherits="Gestion_Web.Formularios.Clientes.ABMGruposClientes" %>
                                    ...
                                    <tr>
                                        <td style="width: 60%">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="El campo es obligatorio" ControlToValidate="txtGrupo" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" ValidationGroup="GrupoClienteGroup"></asp:RequiredFieldValidator>
                                                </div>
                                        </td>
                                        ...
                                        <td style="width: 10%">
                                            <div class="col-md-1">
                                                <div class="shortcuts">
                                                    ...
                                                    <asp:LinkButton ID="lbtnAgregar" runat="server" Text="<span class='shortcut-icon icon-ok'></span>" class="btn btn-success" OnClick="btnAgregar_Click" ValidationGroup="GrupoClienteGroup" />
                    ...
                    <div class="modal-body">
                        <div role="form" class="form-horizontal col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <h5>
                                        <asp:Label runat="server" ID="lblMensaje" Text="Esta seguro que desea eliminar el Grupo?" Style="text-align: center"></asp:Label>
                                    </h5>
                                </div>
