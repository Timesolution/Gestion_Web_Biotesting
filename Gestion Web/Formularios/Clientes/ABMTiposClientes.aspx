<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ABMTiposClientes.aspx.cs" Inherits="Gestion_Web.Formularios.Clientes.ABMTiposClientes" %>
                        ...
                        <div class="widget stacked">
                            ...
                            <div class="widget-content">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 60%">
                                            <label class="col-md-2">Tipos</label>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="El campo es obligatorio" ControlToValidate="txtTipos" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" ValidationGroup="TipoGroup"></asp:RequiredFieldValidator>
                                                </div>
                                        </td>
                                        ...
                                        <td style="width: 10%">
                                            <div class="col-md-1">
                                                <div class="shortcuts">
                                                    ...
                                                    <asp:LinkButton ID="lbtnAgregar" runat="server" Text="<span class='shortcut-icon icon-ok'></span>" class="btn btn-success" OnClick="btnAgregar_Click" ValidationGroup="TipoGroup" />
                    ...
                    <div class="modal-body">
                        <div role="form" class="form-horizontal col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <h5>
                                        <asp:Label runat="server" ID="lblMensaje" Text="Esta seguro que desea eliminar el Tipo?" Style="text-align: center"></asp:Label>
                                    </h5>
                                </div>
