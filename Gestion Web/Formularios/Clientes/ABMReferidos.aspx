<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ABMReferidos.aspx.cs" Inherits="Gestion_Web.Formularios.Clientes.ABMReferidos" %>
                                    ...
                                    <tr>
                                        <td style="width: 60%">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="El campo es obligatorio" ControlToValidate="txtDescripcion" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" ValidationGroup="TipoGroup"></asp:RequiredFieldValidator>
                                                </div>
                                        </td>
