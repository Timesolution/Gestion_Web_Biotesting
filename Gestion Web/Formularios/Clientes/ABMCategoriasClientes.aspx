<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ABMCategoriasClientes.aspx.cs" Inherits="Gestion_Web.Formularios.Clientes.ABMCategoriasClientes" %>
                                    ...
                                    <tr>
                                        <td style="width: 60%">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="El campo es obligatorio" ControlToValidate="txtCategoria" SetFocusOnError="true" Font-Bold="true" ForeColor="Red" ValidationGroup="CategoriaCGroup"></asp:RequiredFieldValidator>
                                                </div>
                                        </td>
...
<%--                                                <a onclick="btnAgregar_Click" class="btn btn-default ui-tooltip" data-toggle="tooltip" title data-original-title="Agregar" style="width: 100%">
                                                ...
                                                <asp:LinkButton ID="lbtnAgregar" runat="server" Text="<span class='shortcut-icon icon-ok'></span>" class="btn btn-success" OnClick="btnAgregar_Click" ValidationGroup="CategoriaCGroup"/>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <asp:PlaceHolder ID="phCategorias" runat="server"></asp:PlaceHolder>
                                            </tbody>
                                        </table>
